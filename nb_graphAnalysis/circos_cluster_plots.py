...
``results/graph_generation/cluster_runs/<stage>/cluster_XX`` directories.
"""
...
from shared.paths import CLUSTER_GRAPH_RESULTS, GLOBAL_GRAPH_RESULTS, METADATA_DIR

LOGGER = logging.getLogger(__name__)

DEFAULT_NET_ROOT = GLOBAL_GRAPH_RESULTS
DEFAULT_CLUSTER_ROOT = CLUSTER_GRAPH_RESULTS
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    if gt is None:
        raise SystemExit("graph_tool is required to generate blockmodel plots")

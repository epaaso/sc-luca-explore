...
Usage:
    python nb_graphGeneration/plot_cell_pair.py --stage [early|late] --cluster [ID] --cell1 "CellA" --cell2 "CellB"
"""
...
from shared.paths import EARLY_MEMBERSHIP, LATE_MEMBERSHIP, METADATA_DIR
